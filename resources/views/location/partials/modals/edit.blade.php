<!-- Modal Edit Route -->
<div id="editModal" class="hidden fixed inset-0 flex items-center bg-gray-600 bg-opacity-50 z-50">
                ...
                <div class="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Alamat <span
                                class="text-red-500">*</span></label>
                        <textarea name="address" id="edit_address" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-teal-500"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="province" id="edit_province"
                                class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-100 focus:ring-2 focus:ring-teal-500"
                                placeholder="Jawa Tengah" required>
                        </div>
                    </div>
